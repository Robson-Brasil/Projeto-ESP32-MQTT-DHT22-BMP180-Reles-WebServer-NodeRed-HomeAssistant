...
// IMPORTANT: If you encounter 'undefined reference to pxCurrentTCB' error,
// use this alternative include instead of ESPAsyncWebServer:
// #include <WebServer.h>  // Use standard WebServer instead
// Or install the compatible lacamera fork from: https://github.com/lacamera/ESPAsyncWebServer
...
// Alternative option if ESPAsyncWebServer has compatibility issues:
// #include <WebServer.h>          // Standard WebServer (blocking but stable)
