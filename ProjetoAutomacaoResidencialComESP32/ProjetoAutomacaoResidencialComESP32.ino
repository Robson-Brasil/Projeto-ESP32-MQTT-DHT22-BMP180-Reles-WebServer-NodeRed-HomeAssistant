...
//Bibliotecas // <-- Se for cirar mais uma aba .h e ela fizer alguma alusão ao código, não esqueça de declarar ela aqui nas Bibliotecas
...
IPAddress local_IP(192, 168, 15, 160); // <-- Altere aqui pro IP da sua rede
IPAddress gateway(192, 168, 15, 1);   // <-- Altere aqui pro Gateay da sua rede
...
void initOTA() {
  ...
  ArduinoOTA.setPassword("S3nh@S3gur@"); // <-- Altere aqui a senha para atualziar via OTA
