...
#include <ElegantOTA.h>         // Função: Essa biblioteca facilita a implementação de atualizações de firmware OTA em projetos Arduino. Ela lida com grande parte da complexidade associada a esse processo, permitindo que você atualize o firmware de seus dispositivos remotamente, sem a necessidade de conexão física por meio de um cabo.
